...
import { ArrowLeft, ShoppingBag, Heart, Share2, BadgeCheck } from "lucide-react";
    ...
    <div className="container py-8">
      ...
      <div className="grid md:grid-cols-2 gap-10 mb-20">
        ...
        <div className="flex flex-col justify-center">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-bold mb-3">{artwork.title}</h1>
          ...
          <div className="flex gap-3">
            ...
            <button className="p-3.5 rounded-md border hover:bg-secondary transition-colors">
